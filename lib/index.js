...
//   frog.width = ((canvas.width-25)/2);
//   frog.height = (canvas.height-55)
// }
...
var frog2 = new Frog((canvas.width-25)/2, (canvas.height-100), 35 , 35, canvas)
var frog3 = new Frog((canvas.width-25)/2, (canvas.height-150), 35 , 35, canvas)
var frog4 = new Frog((canvas.width-25)/2, (canvas.height-200), 35 , 35, canvas)
